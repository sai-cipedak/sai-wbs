create or replace function public.create_revision_note_from_authority_review()
returns trigger
language plpgsql
security definer
...
for each row execute function public.create_revision_note_from_authority_review();
